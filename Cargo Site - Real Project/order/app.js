...
function yeniPaketElaveEt() {
  let yeniPaket = ` <div class="list-group list-group-flush border rounded mb-3 p-2">
  ...
  <div class="list-group-item">
    <div class="row">
      ...
      >
        <button class="btn btn-danger" onclick="silPaket(this)">
  ...
  <!-- product -->
  <div class="list-group-item ms-3 row productYaradilanYer">
    <div class="d-flex align-items-center">
      <div class="iconBG me-3">
        <i class="fa-solid fa-box text-white"></i>
      </div>
    ...
    <div class="row mb-3">
      ...
      <div class="col d-flex align-items-center">
        <button class="btn btn-danger" onclick="silProduct(this)">
          <i class="fa-solid fa-trash-can"></i>
        </button>
      </div>
    </div>
...
`;
  ...
  let yeniProductYarat = e.parentElement.parentElement;
